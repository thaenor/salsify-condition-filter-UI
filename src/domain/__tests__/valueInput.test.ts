...
describe('parseRawValue', () => {
    ...
    describe('multi-number input (number in)', () => {
        ...
        it('parses comma-separated numbers', () => {
            ...
            expect(result).toEqual({
                ok: true,
                value: { kind: 'multi-number', values: [10, 20, 30] },
            });
        });
        ...
        it('parses mixed int and float', () => {
            ...
            expect(result).toEqual({
                ok: true,
                value: { kind: 'multi-number', values: [10, 3.14, 20] },
            });
        });
    ...
    describe('enum-multi input (enumerated in)', () => {
        ...
        it('parses multiple valid values', () => {
            ...
            expect(result).toEqual({
                ok: true,
                value: { kind: 'enum-multi', values: ['Active', 'Inactive'] },
            });
        });
        ...
        it('trims whitespace around tokens', () => {
            ...
            expect(result).toEqual({
                ok: true,
                value: { kind: 'enum-multi', values: ['Active', 'Pending'] },
            });
        });
